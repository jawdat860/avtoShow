    ...
    <div className="flex flex-col lg:flex-row relative">
      ...
      <div className="text-white bg-black lg:pl-20 pl-5 pr-5 py-5 lg:py-[30px] w-full lg:w-[55%] relative z-[12]">
        ...
        <div className="text-white">
          <p className="font-bold text-[18px] sm:text-[20px] md:text-[25px] lg:text-[28px] mb-[10px] sm:mb-[15px] md:mb-[20px] hover:text-[#E25A1D] transition-all duration-300">Звоните по телефону</p>
          <p className="font-bold text-[24px] sm:text-[28px] md:text-[32px] lg:text-[38px] mb-[10px] sm:mb-[15px] md:mb-[20px] hover:text-[#E25A1D] transition-all duration-300 hover:cursor-pointer">+7(978) 999-00-88</p>
          <p className="font-bold text-[18px] sm:text-[20px] md:text-[22px] lg:text-[25px] mb-[5px] sm:mb-[7px] md:mb-[10px] hover:text-[#E25A1D] transition-all duration-300 hover:cursor-pointer">Севастополь, ул.Стахановцев,3</p>
          <p className="text-[18px] sm:text-[20px] md:text-[22px] lg:text-[25px] mb-[15px] sm:mb-[20px] md:mb-[30px] hover:text-[#E25A1D] transition-all duration-300">Мы работаем с 10:00 до 21:00</p>
